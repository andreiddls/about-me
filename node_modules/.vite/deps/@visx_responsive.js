...
import { n as require__root, r as require_isObject, t as require__baseGetTag } from "./_baseGetTag-COD4yWBO.js";
...
//#endregion
//#region node_modules/@visx/responsive/esm/hooks/useParentSize.js
...
function useParentSize(_temp) {
	var _ref = _temp === void 0 ? {} : _temp, _ref$initialSize = _ref.initialSize, initialSize = _ref$initialSize === void 0 ? defaultInitialSize$1 : _ref$initialSize, _ref$debounceTime = _ref.debounceTime, debounceTime = _ref$debounceTime === void 0 ? 300 : _ref$debounceTime, _ref$ignoreDimensions = _ref.ignoreDimensions, ignoreDimensions = _ref$ignoreDimensions === void 0 ? defaultIgnoreDimensions : _ref$ignoreDimensions, _ref$enableDebounceLe = _ref.enableDebounceLeadingCall, enableDebounceLeadingCall = _ref$enableDebounceLe === void 0 ? true : _ref$enableDebounceLe, resizeObserverPolyfill = _ref.resizeObserverPolyfill;
	var parentRef = (0, import_react.useRef)(null);
	var animationFrameID = (0, import_react.useRef)(0);
	var _useState = (0, import_react.useState)(_extends$3({}, defaultInitialSize$1, initialSize)), state = _useState[0], setState = _useState[1];
	var resize = (0, import_react.useMemo)(function() {
		...
		return (0, import_debounce.default)(function(incoming) {
			setState(function(existing) {
				return Object.keys(existing).filter(function(key) {
	...
	(0, import_react.useEffect)(function() {
		var observer = new (resizeObserverPolyfill || window.ResizeObserver)(function(entries) {
...
//#endregion
//#region node_modules/@visx/responsive/esm/components/ParentSize.js
var _excluded = [
	"className",
	"children",
	"debounceTime",
...
function ParentSize(_ref) {
	...
	return /* @__PURE__ */ import_react.createElement("div", _extends$2({
		style: parentSizeStyles,
		ref: parentRef,
		className
	}, restProps), children(_extends$2({}, dimensions, {
...
//#endregion
//#region node_modules/@visx/responsive/esm/components/ScaleSVG.js
...
ScaleSVG.propTypes = {
	...
	xOrigin: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.string]),
	yOrigin: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.string]),
	preserveAspectRatio: import_prop_types.default.string,
...
//#endregion
//#region node_modules/@visx/responsive/esm/enhancers/withParentSize.js
function _extends$1() {
...
function withParentSize(BaseComponent, resizeObserverPolyfill) {
	return /* @__PURE__ */ function(_React$Component) {
		_inheritsLoose$1(WrappedComponent, _React$Component);
		function WrappedComponent() {
			...
			_this.resize = (0, import_debounce.default)(function(_ref2) {
				var width = _ref2.width, height = _ref2.height;
				_this.setState({
					parentWidth: width,
					parentHeight: height
				});
			}, (_this$props$debounceT = _this.props.debounceTime) != null ? _this$props$debounceT : 300, { leading: (_this$props$enableDeb = _this.props.enableDebounceLeadingCall) != null ? _this$props$enableDeb : true });
			return _this;
		}
		...
		_proto.render = function render() {
			...
			return /* @__PURE__ */ import_react.createElement("div", {
				...
				ref: this.setRef
			}, parentWidth != null && parentHeight != null && /* @__PURE__ */ import_react.createElement(BaseComponent, _extends$1({
				parentWidth,
				parentHeight
			}, this.props)));
		};
...
//#endregion
//#region node_modules/@visx/responsive/esm/enhancers/withScreenSize.js
function _extends() {
...
function withScreenSize(BaseComponent) {
	return /* @__PURE__ */ function(_React$Component) {
		...
		function WrappedComponent() {
			...
			_this.resize = (0, import_debounce.default)(function() {
			...
			}, (_ref2 = (_this$props$debounceT = _this.props.debounceTime) != null ? _this$props$debounceT : _this.props.windowResizeDebounceTime) != null ? _ref2 : 300, { leading: (_this$props$enableDeb = _this.props.enableDebounceLeadingCall) != null ? _this$props$enableDeb : true });
			return _this;
		}
		var _proto = WrappedComponent.prototype;
		_proto.componentDidMount = function componentDidMount() {
		...
		_proto.render = function render() {
			...
			return screenWidth == null || screenHeight == null ? null : /* @__PURE__ */ import_react.createElement(BaseComponent, _extends({
				screenWidth,
				screenHeight
			}, this.props));
		};
...
//#endregion
//#region node_modules/@visx/responsive/esm/hooks/useScreenSize.js
var defaultInitialSize = {
	width: 0,
	height: 0
};
var useScreenSize = function useScreenSize(_temp) {
	var _ref = _temp === void 0 ? {} : _temp, _ref$initialSize = _ref.initialSize, initialSize = _ref$initialSize === void 0 ? defaultInitialSize : _ref$initialSize, _ref$debounceTime = _ref.debounceTime, debounceTime = _ref$debounceTime === void 0 ? 300 : _ref$debounceTime, _ref$enableDebounceLe = _ref.enableDebounceLeadingCall, enableDebounceLeadingCall = _ref$enableDebounceLe === void 0 ? true : _ref$enableDebounceLe;
	var _useState = (0, import_react.useState)(initialSize), screenSize = _useState[0], setScreenSize = _useState[1];
	var handleResize = (0, import_react.useMemo)(function() {
...
//#endregion
export { ParentSize, ScaleSVG, useParentSize, useScreenSize, withParentSize, withScreenSize };
