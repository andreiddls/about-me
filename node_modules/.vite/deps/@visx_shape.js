...
import { t as require_prop_types } from "./prop-types-DDYMwZM_.js";
import { n as require_classnames, t as Group } from "./esm-DalQwTGE.js";
...
function line_default() {
	var x$2 = x, y$2 = y, defined = constant_default(true), context = null, curve = linear_default, output = null;
	function line(data) {
...
var curveRadialLinear = curveRadial$1(linear_default);
...
function stack_default() {
	...
	stack.order = function(_) {
		return arguments.length ? (order = _ == null ? none_default : typeof _ === "function" ? _ : constant_default(slice.call(_)), stack) : order;
	};
...
//#endregion
//#region node_modules/@visx/shape/esm/util/setNumberOrNumberAccessor.js
...
//#endregion
//#region node_modules/@visx/shape/esm/util/stackOrder.js
var STACK_ORDERS = {
...
//#endregion
//#region node_modules/@visx/shape/esm/util/stackOffset.js
var STACK_OFFSETS = {
...
//#endregion
//#region node_modules/@visx/shape/esm/util/D3ShapeFactories.js
function arc(_temp) {
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/Arc.js
var _excluded$28 = [
	"className",
	"data",
	"innerRadius",
...
function Arc(_ref) {
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path }));
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$29({
		ref: innerRef,
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/Pie.js
var _excluded$27 = [
	"className",
	"top",
	"left",
...
function Pie(_ref) {
	...
	var arcs = pie$1(data);
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({
		arcs,
		path,
		pie: pie$1
	}));
	return /* @__PURE__ */ import_react.createElement(Group, {
		...
		return /* @__PURE__ */ import_react.createElement("g", { key: "pie-arc-" + i }, /* @__PURE__ */ import_react.createElement("path", _extends$28({
			className: (0, import_classnames.default)("visx-pie-arc", className),
			d: path(arc) || "",
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/Line.js
var _excluded$26 = [
	"from",
	"to",
	"fill",
...
function Line(_ref) {
	var _ref$from = _ref.from, from = _ref$from === void 0 ? {
		...
		x: 1,
		y: 1
	} : _ref$to, _ref$fill = _ref.fill, fill = _ref$fill === void 0 ? "transparent" : _ref$fill, className = _ref.className, innerRef = _ref.innerRef, restProps = _objectWithoutPropertiesLoose$26(_ref, _excluded$26);
	var isRectilinear = from.x === to.x || from.y === to.y;
	return /* @__PURE__ */ import_react.createElement("line", _extends$27({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-line", className),
		x1: from.x,
		y1: from.y,
		x2: to.x,
		y2: to.y,
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/LinePath.js
var _excluded$25 = [
	"children",
	"data",
	"x",
...
function LinePath(_ref) {
	var children = _ref.children, _ref$data = _ref.data, data = _ref$data === void 0 ? [] : _ref$data, x = _ref.x, y = _ref.y, _ref$fill = _ref.fill, fill = _ref$fill === void 0 ? "transparent" : _ref$fill, className = _ref.className, curve = _ref.curve, innerRef = _ref.innerRef, _ref$defined = _ref.defined, defined = _ref$defined === void 0 ? function() {
		return true;
	} : _ref$defined, restProps = _objectWithoutPropertiesLoose$25(_ref, _excluded$25);
	var path = line({
		x,
		y,
		defined,
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$26({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-linepath", className),
		d: path(data) || "",
		fill,
		strokeLinecap: "round"
	}, restProps));
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/LineRadial.js
var _excluded$24 = [
	"className",
	"angle",
	"radius",
...
function LineRadial(_ref) {
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$25({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-line-radial", className),
		d: path(data) || "",
		fill
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/Area.js
var _excluded$23 = [
	"children",
	"x",
	"x0",
...
function Area(_ref) {
	var children = _ref.children, x = _ref.x, x0 = _ref.x0, x1 = _ref.x1, y = _ref.y, y0 = _ref.y0, y1 = _ref.y1, _ref$data = _ref.data, data = _ref$data === void 0 ? [] : _ref$data, _ref$defined = _ref.defined, defined = _ref$defined === void 0 ? function() {
		return true;
	} : _ref$defined, className = _ref.className, curve = _ref.curve, innerRef = _ref.innerRef, restProps = _objectWithoutPropertiesLoose$23(_ref, _excluded$23);
	var path = area({
		x,
		x0,
		x1,
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$24({
		ref: innerRef,
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/AreaClosed.js
var _excluded$22 = [
	"x",
	"x0",
	"x1",
...
function AreaClosed(_ref) {
	var x = _ref.x, x0 = _ref.x0, x1 = _ref.x1, y = _ref.y, y1 = _ref.y1, y0 = _ref.y0, yScale = _ref.yScale, _ref$data = _ref.data, data = _ref$data === void 0 ? [] : _ref$data, _ref$defined = _ref.defined, defined = _ref$defined === void 0 ? function() {
		return true;
	} : _ref$defined, className = _ref.className, curve = _ref.curve, innerRef = _ref.innerRef, children = _ref.children, restProps = _objectWithoutPropertiesLoose$22(_ref, _excluded$22);
	var path = area({
		x,
		x0,
		x1,
 ...
 /**
	...
	*/
	...
	else setNumberOrNumberAccessor(path.y0, y0);
	if (y && !y1) setNumberOrNumberAccessor(path.y1, y);
	if (y1 && !y) setNumberOrNumberAccessor(path.y1, y1);
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$23({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-area-closed", className),
		d: path(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/Stack.js
var _excluded$21 = [
	"className",
	"top",
	"left",
...
function Stack(_ref) {
	...
	return /* @__PURE__ */ import_react.createElement(Group, {
		...
		return /* @__PURE__ */ import_react.createElement("path", _extends$22({
			className: (0, import_classnames.default)("visx-stack", className),
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/AreaStack.js
var _excluded$20 = [
	"className",
	"top",
	"left",
...
function AreaStack(_ref) {
	var className = _ref.className, top = _ref.top, left = _ref.left, keys = _ref.keys, data = _ref.data, curve = _ref.curve, defined = _ref.defined, x = _ref.x, x0 = _ref.x0, x1 = _ref.x1, y0 = _ref.y0, y1 = _ref.y1, value = _ref.value, order = _ref.order, offset = _ref.offset, color = _ref.color, children = _ref.children, restProps = _objectWithoutPropertiesLoose$20(_ref, _excluded$20);
	return /* @__PURE__ */ import_react.createElement(Stack, _extends$21({
		className,
		top,
		left,
		keys,
		...
		return stacks.map(function(series, i) {
			return /* @__PURE__ */ import_react.createElement("path", _extends$21({
				className: (0, import_classnames.default)("visx-area-stack", className),
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/Bar.js
var _excluded$19 = ["className", "innerRef"];
...
function Bar(_ref) {
	var className = _ref.className, innerRef = _ref.innerRef, restProps = _objectWithoutPropertiesLoose$19(_ref, _excluded$19);
	return /* @__PURE__ */ import_react.createElement("rect", _extends$20({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-bar", className)
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/BarRounded.js
var _excluded$18 = [
	"children",
	"className",
	"innerRef",
...
function BarRounded(_ref2) {
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$19({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-bar-rounded", className),
		d: path
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/util/getBandwidth.js
function getBandwidth(scale) {
	if ("bandwidth" in scale) return scale.bandwidth();
	var range = scale.range();
	var domain = scale.domain();
	return Math.abs(range[range.length - 1] - range[0]) / domain.length;
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/BarGroup.js
var _excluded$17 = [
	"data",
	"className",
	"top",
...
function BarGroup(_ref) {
	var data = _ref.data, className = _ref.className, top = _ref.top, left = _ref.left, x0 = _ref.x0, x0Scale = _ref.x0Scale, x1Scale = _ref.x1Scale, yScale = _ref.yScale, color = _ref.color, keys = _ref.keys, height = _ref.height, children = _ref.children, restProps = _objectWithoutPropertiesLoose$17(_ref, _excluded$17);
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children(barGroups));
	return /* @__PURE__ */ import_react.createElement(Group, {
		className: (0, import_classnames.default)("visx-bar-group", className),
		top,
		left
		...
		return /* @__PURE__ */ import_react.createElement(Group, {
			...
			return /* @__PURE__ */ import_react.createElement(Bar, _extends$18({
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/BarGroupHorizontal.js
var _excluded$16 = [
	"data",
	"className",
	"top",
...
function BarGroupHorizontal(_ref) {
	var data = _ref.data, className = _ref.className, top = _ref.top, left = _ref.left, _ref$x = _ref.x, x = _ref$x === void 0 ? function() {
		return 0;
	} : _ref$x, y0 = _ref.y0, y0Scale = _ref.y0Scale, y1Scale = _ref.y1Scale, xScale = _ref.xScale, color = _ref.color, keys = _ref.keys;
	_ref.width;
	var children = _ref.children, restProps = _objectWithoutPropertiesLoose$16(_ref, _excluded$16);
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children(barGroups));
	return /* @__PURE__ */ import_react.createElement(Group, {
		className: (0, import_classnames.default)("visx-bar-group-horizontal", className),
		top,
		left
	}, barGroups.map(function(barGroup) {
		return /* @__PURE__ */ import_react.createElement(Group, {
			...
			return /* @__PURE__ */ import_react.createElement(Bar, _extends$17({
				key: "bar-group-bar-" + barGroup.index + "-" + bar.index + "-" + bar.value + "-" + bar.key,
				x: bar.x,
				y: bar.y,
				width: bar.width,
...
//#endregion
//#region node_modules/@visx/shape/esm/util/accessors.js
function getX$1(l) {
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/BarStack.js
var _excluded$15 = [
	"data",
	"className",
	"top",
...
function BarStack(_ref) {
		...
		return {
			...
			bars: barStack.map(function(bar, j) {
				...
				return {
					...
					height: barHeight,
					width: barWidth,
					x: ("bandwidth" in xScale ? xScale(x(bar.data)) : Math.max((xScale(x(bar.data)) || 0) - barWidth / 2)) || 0,
					y: barY || 0,
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children(barStacks));
	return /* @__PURE__ */ import_react.createElement(Group, {
		className: (0, import_classnames.default)("visx-bar-stack", className),
		top,
		left
	}, barStacks.map(function(barStack) {
		return barStack.bars.map(function(bar) {
			return /* @__PURE__ */ import_react.createElement(Bar, _extends$16({
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/BarStackHorizontal.js
var _excluded$14 = [
	"data",
	"className",
	"top",
...
function BarStackHorizontal(_ref) {
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children(barStacks));
	return /* @__PURE__ */ import_react.createElement(Group, {
		className: (0, import_classnames.default)("visx-bar-stack-horizontal", className),
		top,
		left
	}, barStacks.map(function(barStack) {
		return barStack.bars.map(function(bar) {
			return /* @__PURE__ */ import_react.createElement(Bar, _extends$15({
				key: "bar-stack-" + barStack.index + "-" + bar.index,
				x: bar.x,
				y: bar.y,
				height: bar.height,
...
//#endregion
//#region node_modules/@visx/shape/esm/util/trigonometry.js
var degreesToRadians = function degreesToRadians(degrees) {
	return Math.PI / 180 * degrees;
};
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/diagonal/LinkHorizontal.js
var _excluded$13 = [
	"className",
	"children",
	"data",
...
function LinkHorizontalDiagonal(_ref2) {
	var className = _ref2.className, children = _ref2.children, data = _ref2.data, innerRef = _ref2.innerRef, path = _ref2.path, _ref2$x = _ref2.x, x = _ref2$x === void 0 ? getY$1 : _ref2$x, _ref2$y = _ref2.y, y = _ref2$y === void 0 ? getX$1 : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose$13(_ref2, _excluded$13);
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path: pathGen }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$14({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-horizontal-diagonal", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/diagonal/LinkVertical.js
var _excluded$12 = [
	"className",
	"children",
	"data",
...
function LinkVerticalDiagonal(_ref2) {
	var className = _ref2.className, children = _ref2.children, data = _ref2.data, innerRef = _ref2.innerRef, path = _ref2.path, _ref2$x = _ref2.x, x = _ref2$x === void 0 ? getX$1 : _ref2$x, _ref2$y = _ref2.y, y = _ref2$y === void 0 ? getY$1 : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose$12(_ref2, _excluded$12);
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path: pathGen }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$13({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-vertical-diagonal", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/diagonal/LinkRadial.js
var _excluded$11 = [
	"className",
	"children",
	"data",
...
function LinkRadialDiagonal(_ref2) {
	var className = _ref2.className, children = _ref2.children, data = _ref2.data, innerRef = _ref2.innerRef, path = _ref2.path, _ref2$angle = _ref2.angle, angle = _ref2$angle === void 0 ? getX$1 : _ref2$angle, _ref2$radius = _ref2.radius, radius = _ref2$radius === void 0 ? getY$1 : _ref2$radius, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose$11(_ref2, _excluded$11);
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path: pathGen }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$12({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-radial-diagonal", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/curve/LinkHorizontalCurve.js
var _excluded$10 = [
	"className",
	"children",
	"data",
...
function pathHorizontalCurve(_ref) {
	...
	return function(link) {
		...
		var path$8 = path();
		path$8.moveTo(sx, sy);
		path$8.bezierCurveTo(sx + ix, sy + iy, tx + iy, ty - ix, tx, ty);
		return path$8.toString();
	};
}
function LinkHorizontalCurve(_ref2) {
	var className = _ref2.className, children = _ref2.children, data = _ref2.data, innerRef = _ref2.innerRef, path = _ref2.path, _ref2$percent = _ref2.percent, percent = _ref2$percent === void 0 ? .2 : _ref2$percent, _ref2$x = _ref2.x, x = _ref2$x === void 0 ? getY$1 : _ref2$x, _ref2$y = _ref2.y, y = _ref2$y === void 0 ? getX$1 : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose$10(_ref2, _excluded$10);
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path: pathGen }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$11({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-horizontal-curve", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/curve/LinkVerticalCurve.js
var _excluded$9 = [
	"className",
	"children",
	"data",
...
function pathVerticalCurve(_ref) {
	...
	return function(link) {
		...
		var path$7 = path();
		path$7.moveTo(sx, sy);
		path$7.bezierCurveTo(sx + ix, sy + iy, tx + iy, ty - ix, tx, ty);
		return path$7.toString();
	};
}
function LinkVerticalCurve(_ref2) {
	var className = _ref2.className, children = _ref2.children, data = _ref2.data, innerRef = _ref2.innerRef, path = _ref2.path, _ref2$percent = _ref2.percent, percent = _ref2$percent === void 0 ? .2 : _ref2$percent, _ref2$x = _ref2.x, x = _ref2$x === void 0 ? getX$1 : _ref2$x, _ref2$y = _ref2.y, y = _ref2$y === void 0 ? getY$1 : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose$9(_ref2, _excluded$9);
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path: pathGen }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$10({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-vertical-curve", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/curve/LinkRadialCurve.js
var _excluded$8 = [
	"className",
	"children",
	"data",
...
function pathRadialCurve(_ref) {
	...
	return function(link) {
		...
		var path$6 = path();
		path$6.moveTo(sx, sy);
		path$6.bezierCurveTo(sx + ix, sy + iy, tx + iy, ty - ix, tx, ty);
		return path$6.toString();
	};
}
function LinkRadialCurve(_ref2) {
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path: pathGen }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$9({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-radial-curve", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/line/LinkHorizontalLine.js
var _excluded$7 = [
	"className",
	"children",
	"innerRef",
...
function pathHorizontalLine(_ref) {
	...
	return function(data) {
		...
		path$5.moveTo(sx, sy);
		path$5.lineTo(tx, ty);
		return path$5.toString();
	};
}
function LinkHorizontalLine(_ref2) {
	var className = _ref2.className, children = _ref2.children, innerRef = _ref2.innerRef, data = _ref2.data, path = _ref2.path, _ref2$x = _ref2.x, x = _ref2$x === void 0 ? getY$1 : _ref2$x, _ref2$y = _ref2.y, y = _ref2$y === void 0 ? getX$1 : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose$7(_ref2, _excluded$7);
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path: pathGen }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$8({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-horizontal-line", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/line/LinkVerticalLine.js
var _excluded$6 = [
	"className",
	"innerRef",
	"data",
...
function LinkVerticalLine(_ref2) {
	var className = _ref2.className, innerRef = _ref2.innerRef, data = _ref2.data, path = _ref2.path, _ref2$x = _ref2.x, x = _ref2$x === void 0 ? getX$1 : _ref2$x, _ref2$y = _ref2.y, y = _ref2$y === void 0 ? getY$1 : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, children = _ref2.children, restProps = _objectWithoutPropertiesLoose$6(_ref2, _excluded$6);
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path: pathGen }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$7({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-vertical-line", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/line/LinkRadialLine.js
var _excluded$5 = [
	"className",
	"innerRef",
	"data",
...
function pathRadialLine(_ref) {
	...
	return function(data) {
		...
		var ts = Math.sin(ta);
		var path$3 = path();
		path$3.moveTo(sr * sc, sr * ss);
		path$3.lineTo(tr * tc, tr * ts);
		return path$3.toString();
	};
}
function LinkRadialLine(_ref2) {
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path: pathGen }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$6({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-radial-line", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/step/LinkHorizontalStep.js
var _excluded$4 = [
	"className",
	"innerRef",
	"data",
...
function pathHorizontalStep(_ref) {
	...
	return function(link) {
		...
		var path$2 = path();
		path$2.moveTo(sx, sy);
		path$2.lineTo(sx + (tx - sx) * percent, sy);
		path$2.lineTo(sx + (tx - sx) * percent, ty);
		path$2.lineTo(tx, ty);
		return path$2.toString();
	};
}
function LinkHorizontalStep(_ref2) {
	var className = _ref2.className, innerRef = _ref2.innerRef, data = _ref2.data, path = _ref2.path, _ref2$percent = _ref2.percent, percent = _ref2$percent === void 0 ? .5 : _ref2$percent, _ref2$x = _ref2.x, x = _ref2$x === void 0 ? getY$1 : _ref2$x, _ref2$y = _ref2.y, y = _ref2$y === void 0 ? getX$1 : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, children = _ref2.children, restProps = _objectWithoutPropertiesLoose$4(_ref2, _excluded$4);
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$5({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-horizontal-step", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/step/LinkVerticalStep.js
var _excluded$3 = [
	"className",
	"innerRef",
	"data",
...
function LinkVerticalStep(_ref2) {
	var className = _ref2.className, innerRef = _ref2.innerRef, data = _ref2.data, path = _ref2.path, _ref2$percent = _ref2.percent, percent = _ref2$percent === void 0 ? .5 : _ref2$percent, _ref2$x = _ref2.x, x = _ref2$x === void 0 ? getX$1 : _ref2$x, _ref2$y = _ref2.y, y = _ref2$y === void 0 ? getY$1 : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, children = _ref2.children, restProps = _objectWithoutPropertiesLoose$3(_ref2, _excluded$3);
	...
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ path: pathGen }));
	return /* @__PURE__ */ import_react.createElement("path", _extends$4({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-vertical-step", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/link/step/LinkRadialStep.js
var _excluded$2 = [
	"className",
	"innerRef",
	"data",
...
function LinkRadialStep(_ref2) {
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$3({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-link visx-link-radial-step", className),
		d: pathGen(data) || ""
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/Polygon.js
var _excluded$1 = [
	"sides",
	"size",
	"center",
...
var getPoint = function getPoint(_ref) {
	...
	var radians = degreesToRadians(360 / sides * side - rotate);
	return {
...
function Polygon(_ref3) {
	...
	var pointsToRender = points || getPoints({
		...
		return [_ref4.x, _ref4.y];
	});
	if (children) return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children({ points: pointsToRender }));
	return /* @__PURE__ */ import_react.createElement("polygon", _extends$2({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-polygon", className),
		points: pointsToRender.join(" ")
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/shapes/Circle.js
...
function Circle(_ref) {
	var className = _ref.className, innerRef = _ref.innerRef, restProps = _objectWithoutPropertiesLoose(_ref, _excluded);
	return /* @__PURE__ */ import_react.createElement("circle", _extends$1({
		ref: innerRef,
		className: (0, import_classnames.default)("visx-circle", className)
	}, restProps));
}
//#endregion
//#region node_modules/@visx/shape/esm/util/getOrCreateMeasurementElement.js
...
//#endregion
//#region node_modules/@visx/shape/esm/util/getSplitLineSegments.js
...
function getSplitLineSegments(_ref) {
	...
	try {
		...
		if (segmentation === "x" || segmentation === "y") {
			...
			var isBeyondSegmentStart = pathElement.getPointAtLength(totalLength)[segmentation] > first[segmentation] ? segmentStarts.map(function(start) {
			...
			for (var distance = 0; distance <= totalLength; distance += sampleRate) {
				...
				while (currentSegment < numSegments - 1 && isBeyondSegmentStart[currentSegment + 1](position)) currentSegment += 1;
			...
			for (var i = 2; i < numSegments; i += 1) _segmentStarts[i] += _segmentStarts[i - 1];
			for (var _i = 0; _i < numSegments; _i += 1) _segmentStarts[_i] *= lengthBetweenPoints;
			...
			for (var _distance = 0; _distance <= totalLength; _distance += sampleRate) {
				...
				while (_currentSegment < numSegments - 1 && _distance >= _segmentStarts[_currentSegment + 1]) _currentSegment += 1;
...
//#endregion
//#region node_modules/@visx/shape/esm/shapes/SplitLinePath.js
function _extends() {
...
function SplitLinePath(_ref) {
	...
	var pointsInSegments = (0, import_react.useMemo)(function() {
	...
	var pathString = (0, import_react.useMemo)(function() {
		return line({
			x,
			y,
			defined,
	...
	var splitLineSegments = (0, import_react.useMemo)(function() {
	...
	return /* @__PURE__ */ import_react.createElement("g", null, splitLineSegments.map(function(segment, index) {
		return children ? /* @__PURE__ */ import_react.createElement(import_react.Fragment, { key: index }, children({
			index,
			segment,
			styles: styles[index] || styles[index % styles.length]
		})) : /* @__PURE__ */ import_react.createElement(LinePath, _extends({
			key: index,
			className,
			data: segment,
			x: getX,
...
//#endregion
export { Arc, Area, AreaClosed, AreaStack, Bar, BarGroup, BarGroupHorizontal, BarRounded, BarStack, BarStackHorizontal, Circle, Line, LinePath, LineRadial, LinkHorizontalDiagonal as LinkHorizontal, LinkHorizontalCurve, LinkHorizontalLine, LinkHorizontalStep, LinkRadialDiagonal as LinkRadial, LinkRadialCurve, LinkRadialLine, LinkRadialStep, LinkVerticalDiagonal as LinkVertical, LinkVerticalCurve, LinkVerticalLine, LinkVerticalStep, Pie, Polygon, STACK_OFFSETS, STACK_OFFSET_NAMES, STACK_ORDERS, STACK_ORDER_NAMES, SplitLinePath, Stack, arc, area, degreesToRadians, getPoint, getPoints, line, pathHorizontalCurve, pathHorizontalDiagonal, pathHorizontalLine, pathHorizontalStep, pathRadialCurve, pathRadialDiagonal, pathRadialLine, pathRadialStep, pathVerticalCurve, pathVerticalDiagonal, pathVerticalLine, pathVerticalStep, pie, radialLine, stack, stackOffset, stackOrder };
