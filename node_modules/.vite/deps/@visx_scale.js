...
define_default(Cubehelix, cubehelix$1, extend(Color, {
	brighter(k) {
		k = k == null ? brighter : Math.pow(brighter, k);
...
//#endregion
//#region node_modules/@visx/scale/esm/operators/domain.js
function applyDomain(scale, config) {
	if (config.domain) if ("nice" in scale || "quantiles" in scale) scale.domain(config.domain);
	else if ("padding" in scale) scale.domain(config.domain);
	else scale.domain(config.domain);
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/range.js
function applyRange(scale, config) {
	if (config.range) if ("padding" in scale) scale.range(config.range);
	else scale.range(config.range);
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/align.js
function applyAlign(scale, config) {
	if ("align" in scale && "align" in config && typeof config.align !== "undefined") scale.align(config.align);
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/base.js
function applyBase(scale, config) {
	if ("base" in scale && "base" in config && typeof config.base !== "undefined") scale.base(config.base);
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/clamp.js
function applyClamp(scale, config) {
	if ("clamp" in scale && "clamp" in config && typeof config.clamp !== "undefined") scale.clamp(config.clamp);
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/constant.js
function applyConstant(scale, config) {
	if ("constant" in scale && "constant" in config && typeof config.constant !== "undefined") scale.constant(config.constant);
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/exponent.js
function applyExponent(scale, config) {
	if ("exponent" in scale && "exponent" in config && typeof config.exponent !== "undefined") scale.exponent(config.exponent);
}
//#endregion
//#region node_modules/@visx/scale/esm/utils/createColorInterpolator.js
var interpolatorMap = {
	lab,
	hcl: hcl_default,
	"hcl-long": hclLong,
...
function createColorInterpolator(interpolate) {
	switch (interpolate) {
		...
		case "cubehelix":
		case "cubehelix-long":
		case "rgb": return interpolatorMap[interpolate];
		default:
	}
...
//#endregion
//#region node_modules/@visx/scale/esm/operators/interpolate.js
...
//#endregion
//#region node_modules/@visx/scale/esm/utils/isUtcScale.js
...
function isUtcScale(scale) {
	return scale.tickFormat(1, TEST_FORMAT)(TEST_TIME) === "2020-02-02 03:04";
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/nice.js
...
function applyNice(scale, config) {
	if ("nice" in config && typeof config.nice !== "undefined" && "nice" in scale) {
		...
		if (typeof nice === "boolean") {
			...
			if (typeof nice === "string") timeScale.nice(isUtc ? utcIntervals[nice] : localTimeIntervals[nice]);
			else {
...
//#endregion
//#region node_modules/@visx/scale/esm/operators/padding.js
function applyPadding(scale, config) {
	if ("padding" in scale && "padding" in config && typeof config.padding !== "undefined") scale.padding(config.padding);
	if ("paddingInner" in scale && "paddingInner" in config && typeof config.paddingInner !== "undefined") scale.paddingInner(config.paddingInner);
	if ("paddingOuter" in scale && "paddingOuter" in config && typeof config.paddingOuter !== "undefined") scale.paddingOuter(config.paddingOuter);
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/reverse.js
function applyReverse(scale, config) {
	if (config.reverse) {
		var reversedRange = scale.range().slice().reverse();
		if ("padding" in scale) scale.range(reversedRange);
		else scale.range(reversedRange);
	}
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/round.js
function applyRound(scale, config) {
	if ("round" in config && typeof config.round !== "undefined") {
		if (config.round && "interpolate" in config && typeof config.interpolate !== "undefined") console.warn("[visx/scale/applyRound] ignoring round: scale config contains round and interpolate. only applying interpolate. config:", config);
		else if ("round" in scale) scale.round(config.round);
		else if ("interpolate" in scale && config.round) scale.interpolate(round_default);
	}
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/unknown.js
function applyUnknown(scale, config) {
	if ("unknown" in scale && "unknown" in config && typeof config.unknown !== "undefined") scale.unknown(config.unknown);
}
//#endregion
//#region node_modules/@visx/scale/esm/operators/zero.js
...
//#endregion
//#region node_modules/@visx/scale/esm/operators/scaleOperator.js
/**
...
function scaleOperator() {
	...
	return function applyOperators(scale, config) {
		if (typeof config !== "undefined") selectedOps.forEach(function(op) {
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/band.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/point.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/linear.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/radial.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/time.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/utc.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/log.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/power.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/ordinal.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/quantize.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/quantile.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/symlog.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/threshold.js
...
//#endregion
//#region node_modules/@visx/scale/esm/scales/squareRoot.js
...
//#endregion
//#region node_modules/@visx/scale/esm/createScale.js
function createScale(config) {
	if (typeof config !== "undefined" && "type" in config) switch (config.type) {
		case "linear": return createLinearScale(config);
		case "log": return createLogScale(config);
		case "pow": return createPowScale(config);
		case "sqrt": return createSqrtScale(config);
		case "symlog": return createSymlogScale(config);
		case "time": return createTimeScale(config);
		case "utc": return createUtcScale(config);
		case "quantile": return createQuantileScale(config);
		case "quantize": return createQuantizeScale(config);
		case "threshold": return createThresholdScale(config);
		case "ordinal": return createOrdinalScale(config);
		case "point": return createPointScale(config);
		case "band": return createBandScale(config);
		default:
	}
	return createLinearScale(config);
}
//#endregion
//#region node_modules/@visx/scale/esm/updateScale.js
...
//#endregion
//#region node_modules/@visx/scale/esm/utils/inferScaleType.js
function inferScaleType(scale) {
	if ("paddingInner" in scale) return "band";
	if ("padding" in scale) return "point";
	if ("quantiles" in scale) return "quantile";
	if ("base" in scale) return "log";
	if ("exponent" in scale) return scale.exponent() === .5 ? "sqrt" : "pow";
	if ("constant" in scale) return "symlog";
	if ("clamp" in scale) {
		if (scale.ticks()[0] instanceof Date) return isUtcScale(scale) ? "utc" : "time";
		return "linear";
	}
	if ("nice" in scale) return "quantize";
	if ("invertExtent" in scale) return "threshold";
	return "ordinal";
}
//#endregion
//#region node_modules/@visx/scale/esm/utils/coerceNumber.js
...
//#endregion
//#region node_modules/@visx/scale/esm/utils/getTicks.js
...
//#endregion
//#region node_modules/@visx/scale/esm/utils/toString.js
function toString(x) {
	return x == null ? void 0 : x.toString();
}
//#endregion
//#region node_modules/@visx/scale/esm/utils/scaleCanBeZeroed.js
var zeroableScaleTypes = new Set([
	"linear",
	"pow",
	"quantize",
	"sqrt",
...
//#endregion
export { coerceNumber, createScale, getTicks, inferScaleType, createBandScale as scaleBand, scaleCanBeZeroed, createLinearScale as scaleLinear, createLogScale as scaleLog, createOrdinalScale as scaleOrdinal, createPointScale as scalePoint, createPowScale as scalePower, createQuantileScale as scaleQuantile, createQuantizeScale as scaleQuantize, createRadialScale as scaleRadial, createSqrtScale as scaleSqrt, createSymlogScale as scaleSymlog, createThresholdScale as scaleThreshold, createTimeScale as scaleTime, createUtcScale as scaleUtc, toString, updateScale };
